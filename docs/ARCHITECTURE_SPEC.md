...
Origen: `~/Documents/PersonalLLM`. Para este diseño se inspeccionaron **nombres de primer nivel y reglas de uso**; no se importaron contenidos personales. La meta es consultar contexto autorizado con filtros y relaciones sin recorrer carpetas en cada conversación.
